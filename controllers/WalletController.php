...
use app\models\search\SearchWallet;
...
class WalletController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $kodeStage = substr('0' . $model->stage, 0);
            $model->id_member = $kodeStage . time() . Yii::$app->security->generateRandomString(8);
        ...
        $model->address = Yii::$app->generate->address();
